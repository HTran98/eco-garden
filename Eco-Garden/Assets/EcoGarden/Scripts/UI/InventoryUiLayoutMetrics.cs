...
namespace EcoGarden.UI
{
    public static class InventoryUiLayoutMetrics
    {
        ...
        public static readonly Vector2 NameAnchorMin = new Vector2(0.20f, 0.52f);
        public static readonly Vector2 NameAnchorMax = new Vector2(0.63f, 0.86f);
        public static readonly Vector2 DetailAnchorMin = new Vector2(0.20f, 0.12f);
        public static readonly Vector2 DetailAnchorMax = new Vector2(0.63f, 0.50f);
        public static readonly Vector2 CountAnchorMin = new Vector2(0.65f, 0.24f);
        public static readonly Vector2 CountAnchorMax = new Vector2(0.76f, 0.76f);
        public static readonly Vector2 ActionAnchorMin = new Vector2(0.78f, 0.18f);
        ...
        public const float MinimumActionWidth = 116f;
    }
}
