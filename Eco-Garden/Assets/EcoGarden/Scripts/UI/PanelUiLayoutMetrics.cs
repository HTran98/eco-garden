...
namespace EcoGarden.UI
{
    public static class PanelUiLayoutMetrics
    {
        ...
        public static readonly Vector2 ResultTitleAnchorMin = new Vector2(0.07f, 0.64f);
        public static readonly Vector2 ResultTitleAnchorMax = new Vector2(0.93f, 0.91f);
        public static readonly Vector2 ResultMessageAnchorMin = new Vector2(0.08f, 0.36f);
        public static readonly Vector2 ResultMessageAnchorMax = new Vector2(0.92f, 0.62f);
        public static readonly Vector2 ResultRestartAnchorMin = new Vector2(0.08f, 0.09f);
        public static readonly Vector2 ResultRestartAnchorMax = new Vector2(0.46f, 0.31f);
        public static readonly Vector2 ResultNextAnchorMin = new Vector2(0.54f, 0.09f);
        public static readonly Vector2 ResultNextAnchorMax = new Vector2(0.92f, 0.31f);
