...
namespace EcoGarden.UI
{
    public static class AndroidHudLayoutMetrics
    {
        ...
        public static readonly Vector2 TimerAnchorMax = new Vector2(0.19f, 0.88f);
        public static readonly Vector2 GoldAnchorMin = new Vector2(0.20f, 0.12f);
        public static readonly Vector2 GoldAnchorMax = new Vector2(0.36f, 0.88f);
        public static readonly Vector2 GemAnchorMin = new Vector2(0.37f, 0.12f);
        public static readonly Vector2 GemAnchorMax = new Vector2(0.52f, 0.88f);
        public static readonly Vector2 LevelButtonAnchorMin = new Vector2(0.54f, 0.14f);
        public static readonly Vector2 LevelButtonAnchorMax = new Vector2(0.64f, 0.86f);
        public static readonly Vector2 MissionButtonAnchorMin = new Vector2(0.65f, 0.14f);
        public static readonly Vector2 MissionButtonAnchorMax = new Vector2(0.77f, 0.86f);
        public static readonly Vector2 ShopButtonAnchorMin = new Vector2(0.78f, 0.14f);
        public static readonly Vector2 ShopButtonAnchorMax = new Vector2(0.87f, 0.86f);
        public static readonly Vector2 PauseButtonAnchorMin = new Vector2(0.88f, 0.14f);
        public static readonly Vector2 PauseButtonAnchorMax = new Vector2(0.98f, 0.86f);
