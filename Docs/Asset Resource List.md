...
| `char_customer_merchant_01_alpha` | Character / NPC skin | `Assets/EcoGarden/Art/Characters/Resources/Characters/char_customer_merchant_01_alpha.png` | First-pass transparent PNG wired | Purchasable Merchant NPC skin; generated from a magenta chroma-key source and saved as alpha PNG. |
| `char_customer_moon_01_alpha` | Character / NPC skin | `Assets/EcoGarden/Art/Characters/Resources/Characters/char_customer_moon_01_alpha.png` | First-pass transparent PNG wired | Purchasable Moon Gardener NPC skin; generated from a magenta chroma-key source and saved as alpha PNG. |
...
| `skin_background_crystal_lotus` | Decor / background skin | `Assets/EcoGarden/Art/Backgrounds/Resources/Backgrounds/bg_crystal_lotus_pond_01.png` | First-pass portrait PNG wired | Buying Crystal Pond changes the gameplay background through the inventory bag; composition is optimized for phone portrait. |
| `skin_background_moon_lotus` | Decor / background skin | `Assets/EcoGarden/Art/Backgrounds/Resources/Backgrounds/bg_moon_lotus_garden_01.png` | First-pass portrait PNG wired | Buying Moon Garden changes the gameplay background through the inventory bag; composition is optimized for phone portrait. |
...
| `skin_npc_merchant` | Decor / NPC skin | `Assets/EcoGarden/Art/Characters/Resources/Characters/char_customer_merchant_01_alpha.png` | First-pass transparent PNG wired | Buying NPC Merchant changes the customer NPC sprite through the inventory bag. |
| `skin_npc_moon` | Decor / NPC skin | `Assets/EcoGarden/Art/Characters/Resources/Characters/char_customer_moon_01_alpha.png` | First-pass transparent PNG wired | Buying NPC Moon Gardener changes the customer NPC sprite through the inventory bag. |
